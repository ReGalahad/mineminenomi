...
public class ListExtraAttributes
{
	...
	public static final AbilityAttribute KUJA_ARROW = new AbilityAttribute("Kuja Arrow").setProjectileModel(new ModelArrow()).setProjectileTexture("kujaarrow").setProjectileDamage(4).setProjectileSize(1.25, 1.25, 1.25).setProjectileTicks(100).setProjectileSpeed(3).setProjectileCollisionSizes(0.5);
	...
	public static final AbilityAttribute CANNON_BALL = new AbilityAttribute("Cannon Ball").setProjectileModel(new ModelSphere()).setProjectileDamage(5).setProjectileSize(3, 3, 3).setProjectileTicks(100).setProjectileColor("0B2D41").setProjectileExplosion(3, false);
}
