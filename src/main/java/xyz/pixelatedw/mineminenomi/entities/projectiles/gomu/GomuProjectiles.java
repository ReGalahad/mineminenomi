...
public class GomuProjectiles
{
	...
	public static class GomuGomuNoRocket extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoKongOrgan extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoElephantGatling extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoJetGatling extends AbilityProjectileEntity
	{
		...
		public void tick()
		{
			for (int i = 0; i < 2; i++)
			{
				...
				this.world.addParticle(ParticleTypes.CLOUD, this.posX + offsetX, this.posY + offsetY, this.posZ + offsetZ, 0.0D, 0.0D, 0.0D);
			}
			super.tick();
		}
	}

	public static class GomuGomuNoGatling extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoLeoBazooka extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoGrizzlyMagnum extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoJetBazooka extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoBazooka extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoPistol extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoJetPistol extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoElephantGun extends AbilityProjectileEntity
	{
	...
	public static class GomuGomuNoKongGun extends AbilityProjectileEntity
	{
