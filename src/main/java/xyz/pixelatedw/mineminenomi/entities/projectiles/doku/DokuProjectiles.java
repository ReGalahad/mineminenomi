...
public class DokuProjectiles 
{
	...
	public static class VenomRoad extends AbilityProjectileEntity
	{
	...
	public static class ChloroBall extends AbilityProjectileEntity
	{
	...
	public static class Hydra extends AbilityProjectileEntity
	{
