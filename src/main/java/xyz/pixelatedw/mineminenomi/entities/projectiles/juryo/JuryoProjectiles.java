package xyz.pixelatedw.mineminenomi.entities.projectiles.juryo;
...
public class JuryoProjectiles
{
	...
	public static class Moko extends AbilityProjectileEntity
	{
	...
	public static class SagariNoRyusei extends AbilityProjectileEntity
	{
