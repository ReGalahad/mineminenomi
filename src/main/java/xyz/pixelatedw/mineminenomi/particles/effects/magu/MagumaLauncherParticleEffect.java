package xyz.pixelatedw.mineminenomi.particles.effects.magu;
...
public class MagumaLauncherParticleEffect extends ParticleEffect
{
	...
	public void spawn(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ)
	{
		for (int i = 0; i < 20; i++)
		{
			...
			data.setTexture(ModResources.MAGU);
			data.setLife(20);
			data.setSize(1.3F);
