...
public class TenseiNoSoen2ParticleEffect extends ParticleEffect
{
	...
	public void spawn(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ)
	{
		...
		while(t < 3)
		{
			...
			for(double theta = 0; theta <= 4 * Math.PI; theta += Math.PI / 16)
			{
				...
				WyHelper.spawnParticles(data, (ServerWorld) world, posX + (x * 1.25) + WyHelper.randomDouble(), posY + 0.5 + y, posZ + (z * 1.25) + WyHelper.randomDouble());
			}
		}
	}
