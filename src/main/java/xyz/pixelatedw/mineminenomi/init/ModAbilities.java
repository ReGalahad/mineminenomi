...
public class ModAbilities
{
	...
	public static final AkumaNoMiItem MAGU_MAGU_NO_MI = new AkumaNoMiItem("Magu Magu no Mi", 3, EnumFruitType.LOGIA, DaiFunkaAbility.INSTANCE, RyuseiKazanAbility.INSTANCE, MeigoAbility.INSTANCE, BakuretsuKazanAbility.INSTANCE, SpecialFlyAbility.INSTANCE, MaguPassiveEvents.INVULNERABILITY_INSTANCE);
