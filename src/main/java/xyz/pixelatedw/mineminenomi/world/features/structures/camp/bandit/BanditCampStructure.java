...
public class BanditCampStructure extends ScatteredStructure<NoFeatureConfig>
{
	...
	{
		return BanditCampStructure.Start::new;
	}
	...
	public static void register(Biome biome)
	{
		...
		{
			biome.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Biome.createDecoratedFeature(ModFeatures.BANDIT_CAMP, IFeatureConfig.NO_FEATURE_CONFIG, Placement.NOPE, IPlacementConfig.NO_PLACEMENT_CONFIG));
			biome.addStructure(ModFeatures.BANDIT_CAMP, IFeatureConfig.NO_FEATURE_CONFIG);
		}
	}
	...
	public static class Start extends StructureStart
	{
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biome)
		{
			...
			BanditCampPieces.addComponents(templateManagerIn, blockpos, new Random(), this.components);
			this.recalculateStructureSize();
			
			WyDebug.debug("Bandit Camp spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
		}
	}
}
