...
public class Dial02Model extends EntityModel
{
	public RendererModel shellA1;
	public RendererModel shellA2;
	public RendererModel shellA3;
	public RendererModel shellA4;
	public RendererModel shellA5;
	public RendererModel shellA6;
	public RendererModel shellB1;
	public RendererModel shellB2;
	public RendererModel shellB3;
	public RendererModel shellB4;

	public Dial02Model()
	{
		this.textureWidth = 50;
		this.textureHeight = 25;
		this.shellA5 = new RendererModel(this, 0, 17);
		...
		this.shellB1 = new RendererModel(this, 19, 0);
		...
		this.shellA1 = new RendererModel(this, 0, 0);
		...
		this.shellA4 = new RendererModel(this, 0, 12);
		...
		this.shellB2 = new RendererModel(this, 19, 6);
		...
		this.shellB4 = new RendererModel(this, 19, 13);
		...
		this.shellA3 = new RendererModel(this, 0, 12);
		...
		this.shellA6 = new RendererModel(this, 0, 17);
		...
		this.shellA2 = new RendererModel(this, 0, 7);
		...
		this.shellB3 = new RendererModel(this, 19, 13);
