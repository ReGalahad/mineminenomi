...
public class FlashAbility extends Ability
{
	...
	{
		List<LivingEntity> list = WyHelper.<LivingEntity>getEntitiesNear(player.getPosition(), player.world, 10, FactionHelper.getOutsideGroupPredicate(player), LivingEntity.class);
		list.remove(player);
