...
public class GearSecondAbility extends ContinuousAbility
{
	...
	private static final AttributeModifier MODIFIER = new AttributeModifier(UUID.fromString("a44a9644-369a-4e18-88d9-323727d3d85b"), "Gear Second Modifier", 1.02, Operation.MULTIPLY_BASE).setSaved(false);
