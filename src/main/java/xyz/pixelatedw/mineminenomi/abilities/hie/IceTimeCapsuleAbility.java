...
public class IceTimeCapsuleAbility extends Ability
{
	...
	{
		List<LivingEntity> list = WyHelper.<LivingEntity>getEntitiesNear(player.getPosition(), player.world, 25, FactionHelper.getOutsideGroupPredicate(player), LivingEntity.class);
		list.remove(player);
