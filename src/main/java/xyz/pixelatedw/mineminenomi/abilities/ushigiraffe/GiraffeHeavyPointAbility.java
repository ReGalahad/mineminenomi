...
public class GiraffeHeavyPointAbility extends ZoanAbility
{
	...
	private static final AttributeModifier SPEED_MODIFIER = new AttributeModifier(UUID.fromString("d171ef28-e77a-418d-927b-ca9a09417189"), "Walk Point Speed Multiplier", 0.4f, AttributeModifier.Operation.MULTIPLY_BASE).setSaved(false);
	...
	private static final AttributeModifier STRENGTH_MODIFIER = new AttributeModifier(UUID.fromString("4b03a4b4-1eb5-464a-8312-0f9079044462"), "Heavy Point Multiplier", 2, AttributeModifier.Operation.ADDITION).setSaved(false);
