...
public class BisonHeavyPointAbility extends ZoanAbility
{
	...
	private static final AttributeModifier ATTACK_SPEED_MODIFIER = new AttributeModifier(UUID.fromString("1d78a133-8a0e-4b8f-8790-1360007d4741"), "Heavy Point Multiplier", -1.8f, AttributeModifier.Operation.ADDITION).setSaved(false);
