...
public class ShamblesAbility extends Ability
{
	...
	private boolean onUseEvent(PlayerEntity player)
	{
		...
		List<LivingEntity> list = WyHelper.<LivingEntity>getEntitiesNear(player.getPosition(), player.world, 20, FactionHelper.getOutsideGroupPredicate(player), LivingEntity.class);
		list.remove(player);
